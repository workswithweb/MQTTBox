        ...
        if(publishersList!=null && publishersList.length>0) {
            ...
            for (var i=publishersList.length;i>0;i--) {
                ...
                if(publisher!=null && publisher.pubId!=null) {
                    ...
                    publishersListView.push(<div key={'key_'+publisher.pubId+'_'+publisherXPos+'_'+subscriberYPos} _grid={{i:publisher.pubId,x:publisherXPos, y:subscriberYPos, w: 1, h: 3}}><Publisher key={'key_'+publisher.pubId+'_'+publisherXPos+'_'+subscriberYPos} bsId={bsObj.bsId} publisherSettings={publisher}/></div>);
                }
            }
        }
        ...
        if(subscribersList!=null && subscribersList.length>0) {
            ...
            for (var i=subscribersList.length;i>0;i--) {
                ...
                if(subscriber!=null && subscriber.subId!=null) {
                    ...
                    subscribersListView.push(<div key={'key_'+subscriber.subId+'_'+subscriberXPos+'_'+subscriberYPos} _grid={{i:subscriber.subId,x:subscriberXPos, y: subscriberYPos, w: 1, h: 3}}><Subscriber key={'key_'+subscriber.subId+'_'+subscriberXPos+'_'+subscriberYPos} bsId={bsObj.bsId} subscriberSettings={subscriber}/></div>);
                }
            }
        }
